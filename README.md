...
> [!NOTE]
> 项目聚焦已实现的禅道 12.x 旧版工作流，暂不提供创建或关闭需求、创建或关闭 Bug、测试用例管理等功能。

## 快速开始

开始前请准备 Java 17 或更高版本、一个支持 STDIO MCP 的客户端，以及可访问的禅道 12.x 站点。运行 `java -version` 可以确认 Java 环境。
...
- 本项目针对禅道 12.x 旧版页面和路由，其他版本或不同路由模式可能无法正常解析
